<aside class="sidenav bg-somon navbar navbar-vertical navbar-expand-xs border-1 border-radius-xl my-4 fixed-start ms-4" id="sidenav-main">
  ...
  <div class="w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ str_contains(request()->url(), 'mytests') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'mytests']) }}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-calendar-grid-58 text-white text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1 text-white">StudyNerd Tests</span>
        </a>
      </li>
      <li class="nav-item">
